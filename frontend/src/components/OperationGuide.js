...
export const operationGuides = {
  ...
  banktransfer: {
    ...
    warning: "Only Admin should apply a global interest multiplier from Bank Interest.",
  },
  resources: {
    title: "Bitcoin Trading",
    purpose: "Increase or decrease a team's Brad Pitt Bitcoin holdings after a trade.",
  ...
  interest: {
    title: "Bank Interest",
    purpose: "Multiply every team's bank balance by one rate and publish the latest applied rate.",
    steps: ["Enter a multiplier such as 1.1 for +10%", "Review the percentage preview", "Apply once and verify All Teams"],
    warning: "This settles interest immediately. Repeating the action compounds the result.",
  },
  broadcast: {
